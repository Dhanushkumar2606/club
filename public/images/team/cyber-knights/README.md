# Cyber Knights — Member Photos (12)

Drop the 12 member photos here and reference them from `data/cyberKnights.ts` (`members` array).
...
Each member entry in `data/cyberKnights.ts`:
...
members: [
  {
    name: "Arun Kumar",
    position: "President",
    image: "/images/team/cyber-knights/arun-kumar.jpg",
    linkedin: null,
  },
  // ...
]
